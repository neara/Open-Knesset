...
def verify(d, o, mks, committees):
    if o.title == d['title'] and o.publication_date == d['date'] and o.author_names == d['author']:
        if o.req_mks == mks or o.req_committees == committees:
            logger.info("%s already exists in db" % d['url'])
            return True
        else:
