...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('persons_person', 'user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='person', null=True, to=orm['auth.User']), keep_default=False)
    ...
    models = {
        ...
        'persons.person': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'person'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'persons.personalias': {
