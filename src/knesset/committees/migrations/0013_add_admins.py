...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field admins on 'Committee'
        db.create_table('committees_committee_admins', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('committee', models.ForeignKey(orm['committees.committee'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('committees_committee_admins', ['committee_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field admins on 'Committee'
        db.delete_table('committees_committee_admins')
    ...
    models = {
        ...
        'committees.committee': {
            ...
            'admins': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'managing_committees'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
